...
pub struct Config {
    ...
    #[orga(version(V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12))]
    ...
    /// its own miner fees.
    #[orga(version(V3, V4, V5, V6, V7, V8, V9, V10, V11, V12))]
    ...
    #[orga(version(V2, V3, V4, V5, V6, V7, V8, V9, V10, V11, V12))]
...
impl MigrateFrom<ConfigV8> for ConfigV9 {
    fn migrate_from(value: ConfigV8) -> OrgaResult<Self> {
        Ok(Self {
            min_checkpoint_interval: value.min_checkpoint_interval,
            max_checkpoint_interval: value.max_checkpoint_interval,
            max_inputs: value.max_inputs,
...
impl MigrateFrom<ConfigV10> for ConfigV11 {
    fn migrate_from(value: ConfigV10) -> OrgaResult<Self> {
        Ok(Self {
            min_checkpoint_interval: value.min_checkpoint_interval,
            max_checkpoint_interval: MAX_CHECKPOINT_INTERVAL,
            max_inputs: value.max_inputs,
...
impl MigrateFrom<ConfigV11> for ConfigV12 {
    fn migrate_from(value: ConfigV11) -> OrgaResult<Self> {
        Ok(Self {
            min_checkpoint_interval: value.min_checkpoint_interval,
            max_checkpoint_interval: MAX_CHECKPOINT_INTERVAL,
            max_inputs: value.max_inputs,
...
impl CheckpointQueue {
    ...
    pub fn should_push(
        ...
        if !self.queue.is_empty() {
            ...
            log::info!("Cp miner fees: {:?}", cp_miner_fees);
